...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=5,
                 ...
                 is_addNoise=True, is_changeLight=True, is_cutout=True, is_rotate_img_bbox=False ,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='D:/yolov9/dataset/VOCdevkit/JPEGImages')
    parser.add_argument('--source_xml_path', type=str, default='D:/yolov9/dataset/VOCdevkit/Annotations')
    parser.add_argument('--save_img_path', type=str, default='D:/yolov9/dataset/img')
    parser.add_argument('--save_xml_path', type=str, default='D:/yolov9/dataset/label')
