...
def get_params():
    params = {
        'weight': 'D:/yolov9/runs/trainygw/exp18/weights/best.pt',  # 训练出来的权重文件
        'cfg': 'ultralytics/cfg/models/Add/YOLOv8m-p2-FASFFHead.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        ...
        'conf_threshold': 0.16,  # 0.6  # 置信度阈值，有的时候你的进度条到一半就停止了就是因为没有高于此值的了
        'ratio': 0.02  # 0.02-0.1
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'F:/YGW/RLT1.jpg',  'D:/yolov9/result7')  # 第一个是检测的文件, 第二个是保存的路径